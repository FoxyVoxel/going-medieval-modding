namespace NSMedieval.Modding
{
    ...
    public static class ModdingUtils
    {
        ...
        public static string BuildPath => Path.Combine(UnityEngine.Application.dataPath, ModsDirectory, GetModName, ExportedDir);
        ...
        public static void CreateDefaultTemplate()
        {
            ...
            CreateDefaultModInfo(DefaultTemplateModName, GetModModel(DefaultTemplateModName, new[] { ModTag.General.ToString() }));
        ...
        private static ModModel GetModModel(string modName, string[] tags, string authorName = "")
        {
            ...
            return new ModModel($"{author}.{modName}".ToLower().Replace(" ", "_"), modName, "Add some description here...", author, "0.1", Application.version, tags);
        }
